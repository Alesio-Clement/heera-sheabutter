    ...
    <div class="slideshow slideshow-wrapper slideshow-carousel">
        <div class="home-slideshow-carousel style2">
            <div class="slide">
                ...
                <div class="details">
                    <div class="inner">
                        <h3 class="collection-grid-item__title">SHEA BUTTER</h3>
                    </div>
                </div>
            </div>
            <div class="slide">
                ...
                <div class="details">
                    <div class="inner">
                        <h3 class="collection-grid-item__title">BODY OILS</h3>
                    </div>
                </div>
            </div>
            <div class="slide">
                ...
                <div class="details">
                    <div class="inner">
                        <h3 class="collection-grid-item__title">SCENTED CANDLES</h3>
                    </div>
                </div>
            </div>
        </div>
