        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
            <div class="category-banner-slider">
                <div class="slide-item">
                    <img src="./assets/images/product-banner.webp" data-src="./assets/images/product-banner.webp"
                        alt="" />
                </div>
                <div class="slide-item">
                    <img src="./assets/images/product-banner-2.webp" data-src="./assets/images/product-banner-2.webp"
                        alt="" />
                </div>
            </div>
                        ...
                        <div class="product-image">
                            <a href="grapeseed-oil.php" class="product-img">
                                <img class="primary blur-up lazyload" data-src="./assets/images/products/grapeseed.webp"
                                    ...
                                    title="GRAPESEED OIL">
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/grapeseed-1.webp"
                                    src="./assets/images/product-images/product28.jpg" alt="GRAPESEED OIL"
                                    title="GRAPESEED OIL">
                            </a>
                        ...
                        <div class="product-image">
                            <a href="body-butter.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload"
                                    data-src="./assets/images/products/body-butter1.webp"
                                    src="./assets/images/products/body-butter1.webp" alt="" title="">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item mb-4">
                        <div class="product-image">
                            <a href="whipped-body-butter.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload"
                                    data-src="./assets/images/products/whipped-butter1.webp"
                                    src="./assets/images/products/whipped-butter1.webp" alt="" title="">
                            </a>
                            <div class="button-set style1">
                                <ul>
                                    <li>
                        ...
                        <div class="product-image">
                            <a href="african-black-soap.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/african.webp"
                                    src="./assets/images/products/african.webp" alt="" title="">
                            </a>
                        ...
                        <div class="product-image">
                            <a href="rosehip.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/rosehip1.webp"
                                    src="./assets/images/products/rosehip1.webp" alt="" title="">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item mb-4">
                        <div class="product-image">
                            <a href="vitamin-e.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/vitamin-e.webp"
                                    src="./assets/images/products/vitamin-e.webp" alt="" title="">
                            </a>
                            <div class="button-set style1">
                                <ul>
                                    <li>
                        ...
                        <div class="product-image">
                            <a href="glow-body-oil.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/glow1.webp"
                                    src="./assets/images/products/glow1.webp" alt="" title="">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-3 item mb-4">
                        <div class="product-image">
                            <a href="body-oil.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/body.webp"
                                    src="./assets/images/products/body.webp" alt="" title="">
                            </a>
                            <div class="button-set style1">
                                <ul>
                                    <li>
                        ...
                        <div class="product-image">
                            <a href="day-at-the-spa.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/day-at1.webp"
                                    src="./assets/images/products/day-at1.webp" alt="" title="">
                            </a>
                        ...
                        <div class="product-image">
                            <a href="amber-noir.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/amber1.webp"
                                    src="./assets/images/products/amber1.webp" alt="" title="">
                            </a>
                            <div class="button-set style1">
                                <ul>
                                    <li>
                        ...
                        <div class="product-image">
                            <a href="red-sangria.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/red1.webp"
                                    src="./assets/images/products/red1.webp" alt="" title="">
                            </a>
                        ...
                        <div class="product-image">
                            <a href="black-sea-salt.php" class="product-img">
                                ...
                                <img class="hover blur-up lazyload" data-src="./assets/images/products/black2.webp"
                                    src="./assets/images/products/black2.webp" alt="" title="">
                            </a>
                            <div class="button-set style1">
                                <ul>
                                    <li>
